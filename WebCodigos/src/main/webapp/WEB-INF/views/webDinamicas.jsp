	...
	<div class="container">
		...
		<div class="row mb-2">
			<div class="col-md-6">
				<div class="card flex-md-row mb-4 box-shadow h-md-250">
					<div class="card-body d-flex flex-column align-items-start">
						<strong class="d-inline-block mb-2 text-primary">Web Dinámicas</strong>
						<h3 class="mb-0">
					...
					<img class="card-img-right flex-auto d-none d-lg-block"
						...
						src="https://algol.dev/wp-content/uploads/2020/10/logo-eclipse.png"
			...
			<div class="col-md-6">
				<div class="card flex-md-row mb-4 box-shadow h-md-250">
					<div class="card-body d-flex flex-column align-items-start">
						<strong class="d-inline-block mb-2 text-success">Web Dinámicas</strong>
						<h3 class="mb-0">
