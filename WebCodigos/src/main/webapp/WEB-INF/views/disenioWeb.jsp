	...
	<div class="container">
		...
		<div class="row mb-2">
			<div class="col-md-6">
				<div class="card flex-md-row mb-4 box-shadow h-md-250">
					<div class="card-body d-flex flex-column align-items-start">
						<strong class="d-inline-block mb-2 text-primary">Diseño
							Web</strong>
						<h3 class="mb-0">
							<a class="text-dark" href="#">Sistema de ventas</a>
						</h3>
						<div class="mb-1 text-muted">Feb 04</div>
						<p class="card-text mb-auto">Sistema de ingreso y ventas de
							planes creado en NetBeans</p>
						<a
							href="https://github.com/dcespedess/webCodigos/releases/download/archivos/Sistema.de.venta.de.entradas.al.cine.rar">Descargar</a>
					</div>
			...
			<div class="col-md-6">
				<div class="card flex-md-row mb-4 box-shadow h-md-250">
					<div class="card-body d-flex flex-column align-items-start">
						<strong class="d-inline-block mb-2 text-success">Diseño
							Web</strong>
						<h3 class="mb-0">
			...
			<div class="row">
				<div class="col-md-8 blog-main">
					...
					<div class="blog-post">
						...
						<h3>Ejemplos HTML</h3>
						<p>Acá podemos ver el código para crear una página de HTML:</p>
						<hr>
						<pre>
						<code>Código HTML:
						&lt!DOCTYPE html&gt
...
&lt/head&gt
&ltbody&gt
    &lth1&gtHola Mundo!&lt/h1&gt
    &ltp&gtEsto es un parrafo&lt/p&gt

    &ltbutton&gtEsto es un botón&lt/button&gt
&lt/body&gt
&lt/html &gt
<hr>
...
<button>Esto es un botón</button>
					...
					<div class="blog-post">
						...
						<p>
							...
							encontraremos ejercicios de páginase Web Dinámicas con conexión a
							bases de datos
						</p>
						<p>
